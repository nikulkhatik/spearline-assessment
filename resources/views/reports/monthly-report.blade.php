                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="monthlyReportTable" class="table table-bordered table-hover">
                                    <thead>
                                    <tr>
                                        <th>Company</th>
                                        <th>Month</th>
...
@push('scripts')
    <script>
        ...
        /* Initialize datatable plugin for monthly report table */
        var monthlyReportTable = $('#monthlyReportTable').DataTable({
            searching: false,
            processing: true,
            serverSide: true,
            paging: true,
            ...
            "sDom": 'Rfrtlip',
            "ajax": {
                url: "{{route('reports.monthlyReport')}}",
                type: 'GET',
                data: function (d) {
            ...
            columns: [
                ...
                {data: 'month', className: 'text-center', name: 'month'},
        ...
        /* Reloads the table data when From input value changes */
        $('#datetimepickerFrom').on("change.datetimepicker", function () {
            monthlyReportTable.draw();
        });

        /* Reloads the table data when To input value changes */
